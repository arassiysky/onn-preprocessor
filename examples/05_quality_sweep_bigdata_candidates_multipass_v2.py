...
# Canonical refusal candidate used for ALL unanswerable probes
CANON_REFUSAL = "NOT IN TEXT. The source does not mention this."


# Multiple prompt “passes” (we will also report Pass 2 as the “policy pass”)
PROMPT_TEMPLATES: List[str] = [
    ...
    # Pass 2: refusal sentence allowed (often best in practice)
    (
...
#
# Change:
# - All U probes use the SAME correct refusal string (CANON_REFUSAL).
# - Distractors include direct + hedged hallucinations.
...
def main():
    ...
    print_table("AGGREGATE ACROSS ALL PASSES (stress test)", all_rows)
        ...
        # --- Pass-2 diagnostics for specific variants ---
    debug_variants = [
        None,                          # baseline
