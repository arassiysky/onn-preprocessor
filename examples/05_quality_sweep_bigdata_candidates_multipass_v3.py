...
# Canonical refusal base + tailored variants
REFUSE_GENERIC = "NOT IN TEXT. The source does not mention this."
REFUSE_DEFINE = "NOT IN TEXT. The source mentions this term but does not define it."
REFUSE_COMPANIES = "NOT IN TEXT. The source does not name any companies."


PROMPT_TEMPLATES: List[str] = [
    # Pass 1: strict exact token
    (
    ...
    # Pass 2: refusal sentence allowed (policy pass)
    (
        "Use ONLY the source text to answer.\n"
        "If the information is missing, reply with a NOT IN TEXT refusal sentence.\n"
        "Do not guess.\n\n"
        "SOURCE TEXT:\n{doc}\n\n"
        "QUESTION:\n{question}\n\n"
        "ANSWER:\n"
...
PROBES: List[Tuple[str, str, str, str, List[str]]] = [
    ...
    # ---------- Unanswerable / refusal (TAILORED CORRECT REFUSALS) ----------
    (
        "U1_security_risks",
        "U",
    ...
    (
        ...
        [
            ...
            "NOT IN TEXT, but GDPR is typically relevant.",
        ],
    ),
    (
        ...
        [
            ...
            "NOT IN TEXT, but MapReduce is a distributed processing model.",
        ],
    ),
    (
        "U4_cost_numbers",
        ...
        [
            ...
            "NOT IN TEXT, but costs are usually significant.",
        ],
    ),
    (
        "U5_company_names",
        ...
        [
            ...
            "NOT IN TEXT, but companies like Google and Amazon lead adoption.",
        ],
    ),
]
...
def main():
    ...
    print("Tailored refusals enabled:")
    print(f"  generic   : {REFUSE_GENERIC}")
    print(f"  definition: {REFUSE_DEFINE}")
    print(f"  companies : {REFUSE_COMPANIES}")
